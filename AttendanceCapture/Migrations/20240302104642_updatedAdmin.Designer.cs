...
namespace AttendanceCapture.Migrations
{
    ...
    [Migration("20240302104642_updatedAdmin")]
            ...
            modelBuilder.Entity("AttendanceCapture.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountStatus = 1,
                            ConcurrencyStamp = "9c05be85-309b-4af5-8974-9e84d58285b9",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGcAvs8zmhLnuA0Rq+fxagNegQNIJRgsCI6PGqplgRrSHYTEPxr9K63H9eM7HynS0g==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "CD478A88CFB7A249937B6A8AAB1CA03A",
                            TimeCreated = new DateTimeOffset(new DateTime(2024, 3, 2, 10, 46, 42, 42, DateTimeKind.Unspecified).AddTicks(5529), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2024, 3, 2, 10, 46, 42, 42, DateTimeKind.Unspecified).AddTicks(5535), new TimeSpan(0, 0, 0, 0, 0)),
