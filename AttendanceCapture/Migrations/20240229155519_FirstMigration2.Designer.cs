...
namespace AttendanceCapture.Migrations
{
    ...
    [Migration("20240229155519_FirstMigration2")]
            ...
            modelBuilder.Entity("AttendanceCapture.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountStatus = 1,
                            ConcurrencyStamp = "e7e71356-30d8-4435-871a-13adbfa03912",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEAkDdj5VlRnLIbfLYrv4c1uAndciT5rDgUewzcLrDNkAEH4FzHZ1HxBwaDAjZDNAbg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "80641C6694B59E4BB79FB32890D07A16",
                            TimeCreated = new DateTimeOffset(new DateTime(2024, 2, 29, 15, 55, 18, 870, DateTimeKind.Unspecified).AddTicks(4000), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2024, 2, 29, 15, 55, 18, 870, DateTimeKind.Unspecified).AddTicks(4011), new TimeSpan(0, 0, 0, 0, 0)),
