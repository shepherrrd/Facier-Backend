...
namespace AttendanceCapture.Migrations
{
    ...
    [Migration("20240309110018_StudentMigration")]
            ...
            modelBuilder.Entity("AttendanceCapture.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountStatus = 1,
                            ConcurrencyStamp = "ca86932f-c4e6-4e85-b1e1-44dbeaffb802",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAED2VZjhoAMhwkMTcwg6VWTZrr0Ww+n4zGVyJSYFUHN2KIZUs0SQUvF97tjFynfBC+g==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "C2F479277AB70849909F856128B5C98A",
                            TimeCreated = new DateTimeOffset(new DateTime(2024, 3, 9, 11, 0, 17, 592, DateTimeKind.Unspecified).AddTicks(1914), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2024, 3, 9, 11, 0, 17, 592, DateTimeKind.Unspecified).AddTicks(1918), new TimeSpan(0, 0, 0, 0, 0)),
