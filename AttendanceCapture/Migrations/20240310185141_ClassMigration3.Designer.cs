...
namespace AttendanceCapture.Migrations
{
    ...
    [Migration("20240310185141_ClassMigration3")]
    partial class ClassMigration3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AttendanceCapture.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountStatus = 1,
                            ConcurrencyStamp = "15add6ec-5c36-4f3a-96d0-465b7ef8bae2",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEFeziu8/XrLAVS5eKe9QwGvcH9w1anmXqtyUEowm6D5nYhQZDFLPI6XNJbEwNbESSA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "727FC69D51B26E4789AD4DD17C70F3A1",
                            TimeCreated = new DateTimeOffset(new DateTime(2024, 3, 10, 18, 51, 40, 942, DateTimeKind.Unspecified).AddTicks(3933), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2024, 3, 10, 18, 51, 40, 942, DateTimeKind.Unspecified).AddTicks(3937), new TimeSpan(0, 0, 0, 0, 0)),
